package net.luanvha2550_hash.PacketHandler;
...
public class InputPacketHandler {
    ...
    public static void manualPacketStopSprint(CommandContext<ServerCommandSource> context) {
        ...
        if (bot == null) {
            context.getSource().sendMessage(Text.of("O bot solicitado não foi encontrado no servidor!"));
            server.sendMessage(Text.literal("Erro! Bot não encontrado!"));
            LOGGER.error("O bot solicitado não foi encontrado no servidor!");
            return;
        }
        ...
        try {
            ...
            context.getSource().sendMessage(Text.of("Ação de agachamento realizada para o bot: " + bot.getName().getString()));
        } catch (Exception e) {
    ...
    public static void manualPacketSprint(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            context.getSource().sendMessage(Text.of("Ação de corrida realizada para o bot: " + bot.getName().getString()));
        } catch (Exception e) {
    ...
    public static void manualPacketPressWKey(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            context.getSource().sendMessage(Text.of("Tecla W pressionada para o bot: " + bot.getName().getString()));
        } catch (Exception e) {
    ...
    public static void manualPacketPressSKey(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            context.getSource().sendMessage(Text.of("Tecla S pressionada para o bot: " + bot.getName().getString()));
    ...
    public static void manualPacketPressAKey(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            context.getSource().sendMessage(Text.of("Tecla A pressionada para o bot: " + bot.getName().getString()));
    ...
    public static void manualPacketPressDKey(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            context.getSource().sendMessage(Text.of("Tecla D pressionada para o bot: " + bot.getName().getString()));
    ...
    public static void manualPacketReleaseMovementKey(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            context.getSource().sendMessage(Text.of("Teclas de movimento liberadas para o bot: " + bot.getName().getString()));
        } catch (Exception e) {
