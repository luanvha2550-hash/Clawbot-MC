...
import net.luanvha2550_hash.Entity.LookController;

import net.luanvha2550_hash.Overlay.ThinkingStateManager;

import net.luanvha2550_hash.PathFinding.ChartPathToBlock;

import net.luanvha2550_hash.PathFinding.GoTo;

import net.luanvha2550_hash.PathFinding.PathTracer;

import net.luanvha2550_hash.PlayerUtils.*;

import net.luanvha2550_hash.PlayerUtils.BlockPlacementTool;

import net.luanvha2550_hash.ServiceLLMClients.LLMClient;

import net.luanvha2550_hash.WebSearch.WebSearchTool;

import net.luanvha2550_hash.GameAI.planner.*;

import org.slf4j.Logger;

import org.slf4j.LoggerFactory;

import static net.luanvha2550_hash.ChatUtils.Helper.JsonUtils.cleanJsonString;
...
public class FunctionCallerV2 {
     ...
     */
    public static void initializePlanner(ServerPlayerEntity bot, net.luanvha2550_hash.GameAI.RLAgent rlAgent) {
        if (markovChain == null) {
    ...
    public static CompletableFuture<Boolean> handleUserGoal(
            ...
            net.luanvha2550_hash.GameAI.RLAgent rlAgent,
    ...
    private static class Tools {
        ...
        private static void searchBlocks(String blockType, int initialRadius, int maxRadius, int radiusIncrement) {
            ...
            try {
                ServerPlayerEntity bot = botSource.getPlayer();
                BlockPos result = net.luanvha2550_hash.Tools.SearchBlocks.searchBlock(
                        bot,
                        blockType,
                        initialRadius,
                        maxRadius,
