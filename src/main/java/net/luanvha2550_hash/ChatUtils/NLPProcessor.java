...
import net.luanvha2550_hash.ChatUtils.CART.CartClassifier;
import net.luanvha2550_hash.ChatUtils.DecisionResolver.DecisionResolver;
import net.luanvha2550_hash.ChatUtils.LIDSNetModel.LIDSNetModelManager;
import net.luanvha2550_hash.ChatUtils.PreProcessing.NLPModelSetup;
import net.luanvha2550_hash.ChatUtils.PreProcessing.OpenNLPProcessor;
...
public class NLPProcessor {
    ...
    public static void ensureLocalNLPModel() {
        ...
        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.startDownload(totalSteps);
        ...
        try {
            ...
            if (!Files.exists(torchModelDir)) {
                currentStepNum++;
                net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Downloading BERT NLP model...", currentStepNum);
                ...
                if (!hash.equalsIgnoreCase(bertModelExpectedHash)) {
                    ...
                    while (currentRetry<=maxRetries) {
                        ...
                        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Verifying BERT model (retry " + currentRetry + ")...", currentStepNum);
                    ...
                    if (currentRetry == maxRetries) {
                        ...
                        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.setError("BERT model download failed");
            ...
            if (!Files.exists(cartDir)) {
                currentStepNum++;
                net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Downloading CART NLP model...", currentStepNum);
                ...
                if (!hash.equalsIgnoreCase(cartExpectedHash)) {
                    ...
                    while (currentRetry <= maxRetries) {
                        ...
                        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Verifying CART model (retry " + currentRetry + ")...", currentStepNum);
                    ...
                    if (currentRetry == maxRetries) {
                        LOGGER.error("Error! Max retries reached and NLP models are still not downloaded. Please check your internet connection or contact developer.");
                        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.setError("CART model download failed");
            ...
            if (!Files.exists(openNlpModelsDir)) {
                ...
                for (Map.Entry<String, String> entry : checkSumFileNameMap.entrySet()) {
                    ...
                    try {
                        ...
                        currentStepNum++;
                        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Downloading OpenNLP: " + fileName, currentStepNum);
                        ...
                        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.setError("OpenNLP download failed");
                    } catch (IOException e) {
            ...
            if (!Files.exists(LidsNetModelDir)) {
                currentStepNum++;
                net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Downloading LIDSNet model...", currentStepNum);
                ...
                if (!hash.equalsIgnoreCase(LIDSNetExpectedHash)) {
                    ...
                    while (currentRetry<=maxRetries) {
                        ...
                        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Verifying LIDSNet (retry " + currentRetry + ")...", currentStepNum);
                    ...
                    if (currentRetry == maxRetries) {
                        LOGGER.error("Error! Max retries reached and NLP models are still not downloaded. Please check your internet connection or contact developer.");
                        net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.setError("LIDSNet download failed");
            ...
            if (Files.exists(torchZipFile)) {
                ...
                currentStepNum++;
                net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Extracting BERT model...", currentStepNum);
            ...
            if (Files.exists(cartZipFile)) {
                currentStepNum++;
                net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Extracting CART model...", currentStepNum);
            ...
            if (Files.exists(LidsNETZipFile)) {
                currentStepNum++;
                net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.updateProgress("Extracting LIDSNet model...", currentStepNum);
            ...
            net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.completeDownload();
            ...
            net.luanvha2550_hash.Overlay.NLPDownloadProgressManager.setError("Failed to download NLP models");
        }
    }
    ...
    public static Intent getIntentionFromLLM(String userPrompt) {
        ...
        try {
            ...
            net.luanvha2550_hash.OllamaClient.OllamaThinkingResponse thinkingResponse =
