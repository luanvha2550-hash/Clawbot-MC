 ...
 * <ul>
 *   <li>{@link net.luanvha2550_hash.Autonomy.Cache.KnowledgeCache} - Thread-safe cache for situation-action mappings</li>
 *   <li>{@link net.luanvha2550_hash.Autonomy.Cache.CachedSituation} - Represents a learned situation with success/failure tracking</li>
 * </ul>
 *
 * <h2>Usage:</h2>
 * <pre>{@code
 ...
 * }</pre>
 *
 * @see net.luanvha2550_hash.Autonomy.Cache.KnowledgeCache
 * @see net.luanvha2550_hash.Autonomy.Cache.CachedSituation
 * @see net.luanvha2550_hash.AIProviders.EmbeddingProvider
 */
