...
public class ReasoningLogScreen extends Screen {
    ...
    public ReasoningLogScreen(Screen parent) {
        super(Text.of("Log de Raciocínio"));
        this.parent = parent;
    }

    @Override
    protected void init() {
        ButtonWidget closeButton = ButtonWidget.builder(Text.of("Fechar"), (btn) -> this.close())
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(this.textRenderer, "Raciocínio Passo-a-Passo:", x, y, white, true);
