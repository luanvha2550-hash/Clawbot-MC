...
public class APIKeysScreen extends Screen {
        ...
        ButtonWidget saveButton = ButtonWidget.builder(Text.of("Salvar"), (btn) -> {
            ...
            if (this.client != null) {
                this.client.getToastManager().add(
                        SystemToast.create(this.client, SystemToast.Type.NARRATOR_TOGGLE, Text.of("Chaves API Salvas!"), Text.of("Suas chaves API foram salvas.")));
            }
        }).dimensions(this.width / 2 - buttonWidth - 10, startY + 190, buttonWidth, fieldHeight).build();
        this.addDrawableChild(saveButton);

        // Done Button
        ButtonWidget doneButton = ButtonWidget.builder(Text.of("Concluído"), (btn) -> {
    ...
    private void saveToFile() {
        ...
        String llmMode = ManualConfig.getActiveProvider();
