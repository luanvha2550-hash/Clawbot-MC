 ...
 * <ul>
 *   <li>{@link net.shasankp000.Autonomy.Memory.LongTermMemory} - Main memory manager with JSON persistence</li>
 *   <li>{@link net.shasankp000.Autonomy.Memory.WorldLocation} - Named locations with metadata</li>
 *   <li>{@link net.shasankp000.Autonomy.Memory.DeathSpot} - Death event records</li>
 * </ul>
 *
 * <h2>Memory Types:</h2>
 * <dl>
 ...
 *
 * @see net.shasankp000.Autonomy.AutonomyContext
 * @see net.shasankp000.Autonomy.Layers.SurvivalLayer
 */
